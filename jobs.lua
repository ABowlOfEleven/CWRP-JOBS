...
TEAM_10TH = DarkRP.createJob("10th Helljumper Marksman", {
    ...
    weapons = {"realistic_hook", "weapon_rpw_binoculars_scout", "zeus_flashbang", "cross_arms_swep", "cc2018_dc17ms_red", "dradio", "climb_swep2", "salute_swep", "tfa_swch_dc17m_10th", "cc2018_dc15p_red"},
    command = "HellMark",
    max = 1,
    salary = 250,
    admin = 0,
